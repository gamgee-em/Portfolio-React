...
const App = () => {
  ...
  const imageArr = [
    ...
    { title: 'Team Builder', description:'is a CL application that assists the team manager in creating professional profiles for their team members.', tech: ['JavaScript', 'HTML', 'CSS', 'BootStrap', 'Inquirer', 'Node JS', 'Jest'], path: teamBuilderImg, url: 'https://github.com/gamgee-em/Team-Profile-Builder', repo:'https://github.com/gamgee-em/Team-Profile-Builder', alt: "Team-Profile-Builder application screenshot", id: 4 },
    { title: 'Bucket List', description:'is a Full Stack application that allows the user to keep track of their bucketlist and order items based on priority.', tech: ['JavaScript', 'HTML', 'CSS', 'BootStrap', 'React JS', 'Node JS'], path: bucketListImg, url: 'https://gamgee-em.github.io/Bucket-List/', repo:'https://github.com/gamgee-em/Bucket-List', alt: "Bucket List application screenshot", id: 5 },
    { title: 'Flobi Events', description:'Flobi is an application that allows the user to grab hourly weather forecasts and a list of events happening in their area from either a simple city search or from their current location.', tech: ['JavaScript', 'HTML', 'CSS', 'BootStrap', 'API'], path: projectApiImg, url: 'https://gamgee-em.github.io/Project-API/', repo:'https://github.com/gamgee-em/Project-API', alt: "Flobi Events application screenshot", id: 6 },  
  ];
