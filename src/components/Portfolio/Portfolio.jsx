...
const Portfolio = ({ modalOpen, setModalOpen, open, close, images, setImages }) => {
        ...
        >
            ...
            <div className='portfolio-card-body' >
                <div className="centered">
                    ...
                    <PortfolioCards close={close} open={open} modalOpen={modalOpen} setModalOpen={setModalOpen} handleProjectDisplay={handleProjectDisplay} images={images} />
                </div>
            </div>
            <AnimatePresence
                initial={false}
